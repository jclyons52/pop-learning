...
(function (global) {
  ...
  // Consonant blends: [blend, word, emoji, spokenSound]
  var blends = [
    ["bl", "block", "🧱", "bluh"],
    ["cl", "clock", "🕐", "cluh"],
    ["fl", "flag", "🏁", "fluh"],
  ...
  var stories = [
    {
      ...
      options: ["run fast", "go to bed", "read a book"],
      answer: 0,
    },
    {
      lines: ["Pip is a cat.", "Pip sat on a mat.", "The mat is red."],
      q: "What colour is the mat?",
  ...
  var phonicsCheck = [
    ...
    { word: "fim", real: false },
    { word: "zog", real: false },
    { word: "quib", real: false },
    { word: "splosh", real: false },
    { word: "thrip", real: false },
    { word: "chom", real: false },
  ];
